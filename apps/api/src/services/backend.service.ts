...
async function signAndSend(tx: any, options: SignAndSendOptions = { extractAddress: false, waitForFinalized: false }): Promise<any> {
    return new Promise((resolve, reject) => {
        ...
        }).then((unsub: any) => unsubscribe = unsub).catch(reject);
    });
}
...
export async function queryMessage(methodName: string, args: any[] = [], options: any = {}): Promise<any> {
...
export async function sendMessage(methodName: string, args: any[] = [], options: any = {}): Promise<any> {
...
export async function createEscrow(provider: string, arbitrator: string, duration: number | bigint, value: string = "10000000000000"): Promise<any> {
...
export async function releasePayment(): Promise<any> { return sendMessage("release_payment"); }
export async function refundClient(): Promise<any> { return sendMessage("refund_client"); }
export async function raiseDispute(): Promise<any> { return sendMessage("raise_dispute"); }
